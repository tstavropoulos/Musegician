...
namespace TASAgency.Collections.Generic
{
    ...
    public sealed class DepletableList<T> : IDepletable<T>
    {
        ...
        public T PopNext()
        {
            if (values.Count == 0)
            {
                Console.WriteLine("List is empty and you tried to draw an element.");
                return default;
            }
            ...
            {
                Console.WriteLine("List is depleted and you tried to draw an element.");
                return default;
            }
        ...
        public void CopyTo(T[] dest, int destIndex)
        {
            ...
            values.CopyTo(
                ...
                count: System.Math.Min(values.Count - currentIndex, dest.Length - destIndex));
        }
