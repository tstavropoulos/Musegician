...
{
    /// <summary>
    /// An interface for a collection that tracks and retains 1derlying values, allowing values to be
    ...
    public interface IDepletable<T> : IEnumerable<T>, ICollection<T>
    {
        ...
        /// <summary>
        /// Removes the next value in the IDepletable, if possible, and returns success
        /// </summary>
